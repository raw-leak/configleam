...
type ConfigleamSecrets struct {
	repository Repository
}

func New(repository Repository) *ConfigleamSecrets {
	return &ConfigleamSecrets{repository: repository}
}

// Method to insert secrets into a map[string]interface{}
func (s *ConfigleamSecrets) InsertSecrets(ctx context.Context, env string, cfg *map[string]interface{}) error {
...
func (s *ConfigleamSecrets) replaceSecretPlaceholders(ctx context.Context, env, str string) (interface{}, error) {
...
func (s *ConfigleamSecrets) insertSecretsIntoArray(ctx context.Context, env string, arr *[]interface{}) error {
	for i, val := range *arr {
...
func (s *ConfigleamSecrets) UpsertSecrets(ctx context.Context, env string, cfg map[string]interface{}) error {
