...
type ConfigleamSecretsEndpoints struct {
	service Service
}

func New(s Service) *ConfigleamSecretsEndpoints {
	return &ConfigleamSecretsEndpoints{s}
}

func (e ConfigleamSecretsEndpoints) UpsertSecretsHandler(w http.ResponseWriter, r *http.Request) {
